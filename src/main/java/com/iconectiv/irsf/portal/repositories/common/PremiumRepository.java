...
public interface PremiumRepository extends ReadOnlyRepository<Premium, Integer>{
	...
	@Query("select p from Premium p where (code in ?1 )")
	List<Premium>  findPremiumRangeByRule33(List<String> codeList);

	@Query("select p from Premium p where (iso2 in ?1 )")
	List<Premium>  findPremiumRangeByRule34(List<String> iso2List);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 )")
	List<Premium>  findPremiumRangeByRule35(List<String> codeList, List<String> iso2List);

	@Query("select p from Premium p where (tos in ?1 )")
	List<Premium>  findPremiumRangeByRule36(List<String> tosList);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 )")
	List<Premium>  findPremiumRangeByRule37(List<String> codeList, List<String> tosList);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 )")
	List<Premium>  findPremiumRangeByRule38(List<String> iso2List, List<String> tosList);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2 ")
	List<Premium>  findPremiumRangeByRule44(List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	List<Premium>  findPremiumRangeByRule45(List<String> codeList, List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	List<Premium>  findPremiumRangeByRule46(List<String> iso2List, List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4 ")
	List<Premium>  findPremiumRangeByRule47(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (provider in ?1 )")
	List<Premium>  findPremiumRangeByRule48(List<String> providerList);

	@Query("select p from Premium p where (code in ?1 ) and (provider in ?2 )")
	List<Premium>  findPremiumRangeByRule49(List<String> codeList, List<String> providerList);

	@Query("select p from Premium p where (iso2 in ?1 ) and (provider in ?2 )")
	List<Premium>  findPremiumRangeByRule50(List<String> iso2List, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule51(List<String> codeList, List<String> iso2List, List<String> providerList);

	@Query("select p from Premium p where (tos in ?1 ) and (provider in ?2 )")
	List<Premium>  findPremiumRangeByRule52(List<String> tosList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule53(List<String> codeList, List<String> tosList, List<String> providerList);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule54(List<String> iso2List, List<String> tosList, List<String> providerList);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2  and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule60(List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	List<Premium>  findPremiumRangeByRule61(List<String> codeList, List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	List<Premium>  findPremiumRangeByRule62(List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4  and (provider in ?5 )")
	List<Premium>  findPremiumRangeByRule63(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 )")
	List<Premium>  findPremiumRangeByRule65(List<String> codeList);

	@Query("select p from Premium p where (iso2 in ?1 )")
	List<Premium>  findPremiumRangeByRule66(List<String> iso2List);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 )")
	List<Premium>  findPremiumRangeByRule67(List<String> codeList, List<String> iso2List);

	@Query("select p from Premium p where (tos in ?1 )")
	List<Premium>  findPremiumRangeByRule68(List<String> tosList);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 )")
	List<Premium>  findPremiumRangeByRule69(List<String> codeList, List<String> tosList);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 )")
	List<Premium>  findPremiumRangeByRule70(List<String> iso2List, List<String> tosList);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2 ")
	List<Premium>  findPremiumRangeByRule76(List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	List<Premium>  findPremiumRangeByRule77(List<String> codeList, List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	List<Premium>  findPremiumRangeByRule78(List<String> iso2List, List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4 ")
	List<Premium>  findPremiumRangeByRule79(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (provider in ?1 )")
	List<Premium>  findPremiumRangeByRule80(List<String> providerList);

	@Query("select p from Premium p where (code in ?1 ) and (provider in ?2 )")
	List<Premium>  findPremiumRangeByRule81(List<String> codeList, List<String> providerList);

	@Query("select p from Premium p where (iso2 in ?1 ) and (provider in ?2 )")
	List<Premium>  findPremiumRangeByRule82(List<String> iso2List, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule83(List<String> codeList, List<String> iso2List, List<String> providerList);

	@Query("select p from Premium p where (tos in ?1 ) and (provider in ?2 )")
	List<Premium>  findPremiumRangeByRule84(List<String> tosList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule85(List<String> codeList, List<String> tosList, List<String> providerList);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule86(List<String> iso2List, List<String> tosList, List<String> providerList);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2  and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule92(List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	List<Premium>  findPremiumRangeByRule93(List<String> codeList, List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	List<Premium>  findPremiumRangeByRule94(List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4  and (provider in ?5 )")
	List<Premium>  findPremiumRangeByRule95(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 )")
	List<Premium>  findPremiumRangeByRule97(List<String> codeList);

	@Query("select p from Premium p where (iso2 in ?1 )")
	List<Premium>  findPremiumRangeByRule98(List<String> iso2List);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 )")
	List<Premium>  findPremiumRangeByRule99(List<String> codeList, List<String> iso2List);

	@Query("select p from Premium p where (tos in ?1 )")
	List<Premium>  findPremiumRangeByRule100(List<String> tosList);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 )")
	List<Premium>  findPremiumRangeByRule101(List<String> codeList, List<String> tosList);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 )")
	List<Premium>  findPremiumRangeByRule102(List<String> iso2List, List<String> tosList);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2 ")
	List<Premium>  findPremiumRangeByRule108(List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	List<Premium>  findPremiumRangeByRule109(List<String> codeList, List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	List<Premium>  findPremiumRangeByRule110(List<String> iso2List, List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4 ")
	List<Premium>  findPremiumRangeByRule111(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList);

	@Query("select p from Premium p where (provider in ?1 )")
	List<Premium>  findPremiumRangeByRule112(List<String> providerList);

	@Query("select p from Premium p where (code in ?1 ) and (provider in ?2 )")
	List<Premium>  findPremiumRangeByRule113(List<String> codeList, List<String> providerList);

	@Query("select p from Premium p where (iso2 in ?1 ) and (provider in ?2 )")
	List<Premium>  findPremiumRangeByRule114(List<String> iso2List, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule115(List<String> codeList, List<String> iso2List, List<String> providerList);

	@Query("select p from Premium p where (tos in ?1 ) and (provider in ?2 )")
	List<Premium>  findPremiumRangeByRule116(List<String> tosList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule117(List<String> codeList, List<String> tosList, List<String> providerList);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule118(List<String> iso2List, List<String> tosList, List<String> providerList);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2  and (provider in ?3 )")
	List<Premium>  findPremiumRangeByRule124(List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	List<Premium>  findPremiumRangeByRule125(List<String> codeList, List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	List<Premium>  findPremiumRangeByRule126(List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4  and (provider in ?5 )")
	List<Premium>  findPremiumRangeByRule127(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList);
	...
	@Query("select p from Premium p where (code in ?1 )")
	Page<Premium>  findPremiumRangeByRule33(List<String> codeList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 )")
	Page<Premium>  findPremiumRangeByRule34(List<String> iso2List, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 )")
	Page<Premium>  findPremiumRangeByRule35(List<String> codeList, List<String> iso2List, Pageable pageable);

	@Query("select p from Premium p where (tos in ?1 )")
	Page<Premium>  findPremiumRangeByRule36(List<String> tosList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 )")
	Page<Premium>  findPremiumRangeByRule37(List<String> codeList, List<String> tosList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 )")
	Page<Premium>  findPremiumRangeByRule38(List<String> iso2List, List<String> tosList, Pageable pageable);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2 ")
	Page<Premium>  findPremiumRangeByRule44(List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	Page<Premium>  findPremiumRangeByRule45(List<String> codeList, List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	Page<Premium>  findPremiumRangeByRule46(List<String> iso2List, List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4 ")
	Page<Premium>  findPremiumRangeByRule47(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (provider in ?1 )")
	Page<Premium>  findPremiumRangeByRule48(List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and (provider in ?2 )")
	Page<Premium>  findPremiumRangeByRule49(List<String> codeList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and (provider in ?2 )")
	Page<Premium>  findPremiumRangeByRule50(List<String> iso2List, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule51(List<String> codeList, List<String> iso2List, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (tos in ?1 ) and (provider in ?2 )")
	Page<Premium>  findPremiumRangeByRule52(List<String> tosList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule53(List<String> codeList, List<String> tosList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule54(List<String> iso2List, List<String> tosList, List<String> providerList, Pageable pageable);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2  and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule60(List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	Page<Premium>  findPremiumRangeByRule61(List<String> codeList, List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	Page<Premium>  findPremiumRangeByRule62(List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4  and (provider in ?5 )")
	Page<Premium>  findPremiumRangeByRule63(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 )")
	Page<Premium>  findPremiumRangeByRule65(List<String> codeList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 )")
	Page<Premium>  findPremiumRangeByRule66(List<String> iso2List, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 )")
	Page<Premium>  findPremiumRangeByRule67(List<String> codeList, List<String> iso2List, Pageable pageable);

	@Query("select p from Premium p where (tos in ?1 )")
	Page<Premium>  findPremiumRangeByRule68(List<String> tosList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 )")
	Page<Premium>  findPremiumRangeByRule69(List<String> codeList, List<String> tosList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 )")
	Page<Premium>  findPremiumRangeByRule70(List<String> iso2List, List<String> tosList, Pageable pageable);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2 ")
	Page<Premium>  findPremiumRangeByRule76(List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	Page<Premium>  findPremiumRangeByRule77(List<String> codeList, List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	Page<Premium>  findPremiumRangeByRule78(List<String> iso2List, List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4 ")
	Page<Premium>  findPremiumRangeByRule79(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (provider in ?1 )")
	Page<Premium>  findPremiumRangeByRule80(List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and (provider in ?2 )")
	Page<Premium>  findPremiumRangeByRule81(List<String> codeList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and (provider in ?2 )")
	Page<Premium>  findPremiumRangeByRule82(List<String> iso2List, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule83(List<String> codeList, List<String> iso2List, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (tos in ?1 ) and (provider in ?2 )")
	Page<Premium>  findPremiumRangeByRule84(List<String> tosList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule85(List<String> codeList, List<String> tosList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule86(List<String> iso2List, List<String> tosList, List<String> providerList, Pageable pageable);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2  and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule92(List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	Page<Premium>  findPremiumRangeByRule93(List<String> codeList, List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	Page<Premium>  findPremiumRangeByRule94(List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4  and (provider in ?5 )")
	Page<Premium>  findPremiumRangeByRule95(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 )")
	Page<Premium>  findPremiumRangeByRule97(List<String> codeList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 )")
	Page<Premium>  findPremiumRangeByRule98(List<String> iso2List, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 )")
	Page<Premium>  findPremiumRangeByRule99(List<String> codeList, List<String> iso2List, Pageable pageable);

	@Query("select p from Premium p where (tos in ?1 )")
	Page<Premium>  findPremiumRangeByRule100(List<String> tosList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 )")
	Page<Premium>  findPremiumRangeByRule101(List<String> codeList, List<String> tosList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 )")
	Page<Premium>  findPremiumRangeByRule102(List<String> iso2List, List<String> tosList, Pageable pageable);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2 ")
	Page<Premium>  findPremiumRangeByRule108(List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	Page<Premium>  findPremiumRangeByRule109(List<String> codeList, List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3 ")
	Page<Premium>  findPremiumRangeByRule110(List<String> iso2List, List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4 ")
	Page<Premium>  findPremiumRangeByRule111(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList, Pageable pageable);

	@Query("select p from Premium p where (provider in ?1 )")
	Page<Premium>  findPremiumRangeByRule112(List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and (provider in ?2 )")
	Page<Premium>  findPremiumRangeByRule113(List<String> codeList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and (provider in ?2 )")
	Page<Premium>  findPremiumRangeByRule114(List<String> iso2List, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule115(List<String> codeList, List<String> iso2List, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (tos in ?1 ) and (provider in ?2 )")
	Page<Premium>  findPremiumRangeByRule116(List<String> tosList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule117(List<String> codeList, List<String> tosList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and (tos in ?2 ) and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule118(List<String> iso2List, List<String> tosList, List<String> providerList, Pageable pageable);
	...
	@Query("select p from Premium p where tos in ?1 or concat(tos,',',tosdesc) in ?2  and (provider in ?3 )")
	Page<Premium>  findPremiumRangeByRule124(List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	Page<Premium>  findPremiumRangeByRule125(List<String> codeList, List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (iso2 in ?1 ) and tos in ?2 or concat(tos,',',tosdesc) in ?3  and (provider in ?4 )")
	Page<Premium>  findPremiumRangeByRule126(List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);

	@Query("select p from Premium p where (code in ?1 or iso2 in ?2 ) and tos in ?3 or concat(tos,',',tosdesc) in ?4  and (provider in ?5 )")
	Page<Premium>  findPremiumRangeByRule127(List<String> codeList, List<String> iso2List, List<String> tosList, List<String> tosDescList, List<String> providerList, Pageable pageable);
