...
public class EventNotification  implements java.io.Serializable {
    ...
    public EventNotification(Integer customerId, String eventType, Integer referenceId, String message, String status, Date createTimestamp, Date acknowledgeTimestamp, String lastUpdatedBy) {
