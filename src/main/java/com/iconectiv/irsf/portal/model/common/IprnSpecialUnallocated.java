 ...
 */
@Entity
@Table(name="iprn_special_unallocated"
    ,catalog="irsfmast"
)
public class IprnSpecialUnallocated  implements java.io.Serializable {
    ...
    public IprnSpecialUnallocated(Date loadDate) {
        this.loadDate = loadDate;
    }
    public IprnSpecialUnallocated(String termCountry, String primeMinus2, String primeMinus3, String primeMinus4, String iso2, String code, String tos, String tosdesc, String ndc, String locality, String provider, String supplement, Integer lemin, Integer lemax, String iprn, String lastUpdate, String filler, Date loadDate, String jobId) {
